...
import com.example.ibuy.viewmodels.MenProductsViewModel;

/** Presents all the men related products from the Product Service
...
public class MenFragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        MenProductsViewModel model = new ViewModelProvider(this)
                .get(MenProductsViewModel.class);
        model.getMenProductsLiveData().observe(this, productServiceResponse -> {
