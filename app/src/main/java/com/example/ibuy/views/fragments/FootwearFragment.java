...
import com.example.ibuy.viewmodels.FootwearProductsViewModel;

/** Presents all the footwear related products from the Product Service
...
public class FootwearFragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        FootwearProductsViewModel model = new ViewModelProvider(this)
                .get(FootwearProductsViewModel.class);
        model.getFootwearLiveData().observe(this, productServiceResponse -> {
